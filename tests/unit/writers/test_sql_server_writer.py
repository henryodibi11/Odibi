...
class TestGetTableColumns:
    ...
    def test_returns_column_dict(self):
        ...
        conn.execute_sql.return_value = [
            ...
            {"COLUMN_NAME": "name", "DATA_TYPE": "nvarchar", "CHARACTER_MAXIMUM_LENGTH": 255,
    ...
    def test_handles_max_length(self):
        ...
        conn = create_mock_connection()
        conn.execute_sql.return_value = [
            {"COLUMN_NAME": "description", "DATA_TYPE": "nvarchar",
...
class TestFilterChangedRowsPandas:
    ...
    def test_filters_unchanged_rows(self):
        ...
        result = writer.filter_changed_rows_pandas(
            source_df, target_hashes, ["id"], "_hash"
        )
...
class TestReadTargetHashes:
    ...
    def test_returns_hashes_when_column_exists(self):
        ...
        conn.execute_sql.side_effect = [
            [{"COLUMN_NAME": "id", "DATA_TYPE": "int",
              "CHARACTER_MAXIMUM_LENGTH": None, "NUMERIC_PRECISION": 10, "NUMERIC_SCALE": 0},
             {"COLUMN_NAME": "_hash", "DATA_TYPE": "nvarchar",
              "CHARACTER_MAXIMUM_LENGTH": 64, "NUMERIC_PRECISION": None, "NUMERIC_SCALE": None}],

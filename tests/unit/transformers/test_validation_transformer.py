...
class TestCrossCheckSchemaMatch:
    ...
    def test_schema_mismatch_different_columns(self, sample_df_a, sample_df_different_schema, pandas_engine):
    ...
    def test_schema_match_multiple_inputs(self, sample_df_a, sample_df_b, sample_df_c, pandas_engine):
    ...
    def test_schema_mismatch_multiple_inputs(self, sample_df_a, sample_df_b, sample_df_different_schema, pandas_engine):
        ...
        params = CrossCheckParams(
            type="schema_match",
            inputs=["node_a", "node_b", "node_diff"]
        )
...
class TestCrossCheckNullHandling:
    ...
    def test_schema_match_with_nulls(self, pandas_engine):
        ...
        df_a = pd.DataFrame({"id": [1, None, 3], "name": ["A", "B", None], "value": [100, 200, None]})
        df_b = pd.DataFrame({"id": [10, 20, None], "name": [None, "X", "Y"], "value": [None, None, 300]})

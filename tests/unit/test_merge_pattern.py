...
class TestMergePatternExecution:
    ...
    def test_execute_calls_merge_transformer(
        self, mock_merge, mock_engine, mock_config
    ):
    ...
    @patch("odibi.patterns.merge.merge")
    def test_execute_uses_default_strategy(
        self, mock_merge, mock_engine, mock_config
    ):
...
class TestMergePatternErrorHandling:
    ...
    @patch("odibi.patterns.merge.merge")
    def test_execute_raises_on_merge_failure(
        self, mock_merge, mock_engine, mock_config
    ):

...
| **connections** | Dict[str, ConnectionConfig] | Yes | - | Named connections (at least one required)<br>**Options:** [LocalConnectionConfig](#localconnectionconfig), [AzureBlobConnectionConfig](#azureblobconnectionconfig), [DeltaConnectionConfig](#deltaconnectionconfig), [SQLServerConnectionConfig](#sqlserverconnectionconfig), [HttpConnectionConfig](#httpconnectionconfig) |
...
| **format** | ReadFormat | Yes | - | Data format (csv, parquet, delta, etc.) |
...
| --- | --- | --- | --- | --- |
| **connection** | str | Yes | - | Connection name from project.yaml |
| **format** | ReadFormat | Yes | - | Output format (csv, parquet, delta, etc.) |
| **table** | Optional[str] | No | - | Table name for SQL/Delta |
...
### `AuditColumnsConfig`
> *Used in: [MergeParams](#mergeparams)*
...
### `CaseWhenCase`
> *Used in: [CaseWhenParams](#casewhenparams)*

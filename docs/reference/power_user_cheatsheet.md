...
Owner:             ____________________ (email)
Freshness SLA:     ____________________ (e.g., 6h, 1d, or leave blank)
...
Incremental:     [ ] No — full load every time (skip below)
  ...
  If stateful:
    ...
    Watermark lag: ____________________  (e.g., "5m" safety buffer)
```
...
[ ] freshness      column: ____________  max_age: ________ (e.g., 24h, 7d)

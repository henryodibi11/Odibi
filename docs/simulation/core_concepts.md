...
| `timestep` | string | Yes | — | Interval between rows (e.g., `5s`, `10m`, `1h`, `2d`) |
| `row_count` | int | Either this or `end_time` | — | Exact number of rows to generate per entity |
| `end_time` | string | Either this or `row_count` | — | ISO8601 end timestamp; Odibi calculates row count automatically |
...
- **[Generators](generators.md)** — All 12 generator types in detail (range, random_walk, categorical, derived, and more)

...
def create_command(args):
    ...
    # Recommend using init-pipeline if they might be better off with a full scaffold
    print(
        "💡 Tip: For a full project structure (folders + config), use: odibi init-pipeline <name>"
    )

...
2. AzureIndexer - Azure AI Search indexing (optional, for cloud deployment)
"""
...
class LocalIndexer:
    """Indexes the Odibi codebase into a local vector store.
...
class AzureIndexer:
    ...
    def create_index(self, force_recreate: bool = False) -> bool:
        ...
        Returns:
            True if successful.
        """
        from agents.core.azure_client import get_odibi_index_schema

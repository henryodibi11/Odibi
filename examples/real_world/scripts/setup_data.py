...
def check_olist_data():
    ...
    print("="*60)
    print(f"We need the Olist E-Commerce dataset to run this showcase.")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--explode", action="store_true", help="Duplicate data 10x for performance testing")

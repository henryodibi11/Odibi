...
from odibi.config import PipelineConfig  # noqa: E402
from odibi.connections import LocalConnection  # noqa: E402
from odibi.pipeline import Pipeline  # noqa: E402
...
def main():
    ...
    pipeline = Pipeline(
        ...
        story_config={"max_sample_rows": 5, "output_path": "./stories/"},
    )
